...
const UploadGlobalController = (props) => {
    ...
    const formik = useFormik({
        ...
        {
            setMyMsg('');
            await UpGlobalController(values.file,setMyMsg,props.myList,props.setMyList,setLoading);
...
async function UpGlobalController(file,setMyMsg,myList,setMyList,setLoading)
{
    setLoading(true);
    let fd = new FormData();
    fd.append("role", 'GADMIN');
    fd.append("file", file);
...
export default UploadGlobalController;