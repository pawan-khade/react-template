...
const validationSchema = Yup.object({
    ...
    .required("Name of Cluster Controller Admin is Required."),
    orgName: Yup.string()
    .required("Organization Name of Cluster Controller Admin is Required."),
    email: Yup.string()
    .required("Email of Cluster Controller Admin is Required.")
    .email(),
    mobile: Yup.number()
    .required("Mobile Number of Cluster Controller Admin is Required."),
    password: Yup.string()
    .required("Password for Login is Required.")
    .min(8, "Password is too short - should be 8 chars minimum"),
});

const ClusterControllerForm = (props) => {
    ...
    const formik = useFormik({
        ...
        {
            setMyMsg('');
            registerCadmin(values.regType, values.controllerName, values.orgName, values.email, values.mobile, values.password,setLoading,setMyMsg,props.setMyList,props.myList);
                                ...
                                <div className="col-lg-12 row">
                                    ...
                                    <div className="col-lg-8">
                                        <select id="regType" name="regType" className="form-control" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.regType}>
                                            ...
                                            <option value="CADMIN">Cluster Controller Admin</option>
                                        </select>
...
async function registerCadmin(regType,controllerName,orgName,email,mobile,password,setLoading,setMyMsg,setMyList,myList)
{
    setLoading(true);
...
export default ClusterControllerForm;