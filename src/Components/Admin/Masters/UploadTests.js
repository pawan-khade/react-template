...
const UploadTests = (props) => {
    ...
    const formik = useFormik({
        ...
        {
            setMyMsg('');
            await UpTests(values.file,setMyMsg,props.myList,props.setMyList,setLoading);
...
async function UpTests(file,setMyMsg,myList,setMyList,setLoading)
{
    setLoading(true);
    ...
    await API.post('/subject/test/upload',fd,config)
    .then(function (res) 
    {
