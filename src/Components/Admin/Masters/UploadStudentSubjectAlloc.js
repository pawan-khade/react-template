...
const UploadStudentSubjectAlloc = (props) => {
    ...
    const formik = useFormik({
        ...
        {
            setMyMsg('');
            await UpStudentSubjectAlloc(values.file,setMyMsg,props.myList,props.setMyList,setLoading);
                ...
                <div className="card mb-4">
                    <form id="form-GCA" method="post" className="form-horizontal" onSubmit={formik.handleSubmit}>
                        <div className="card-header">
                            ...
                            Upload Student Subject Allocation Excel
                        </div>
...
async function UpStudentSubjectAlloc(file,setMyMsg,myList,setMyList,setLoading)
{
    setLoading(true);
    let fd = new FormData();
    fd.append("file", file);
    ...
    await API.post('/exam/upload',fd,config)
    .then(function (res) 
    {
...
export default UploadStudentSubjectAlloc;